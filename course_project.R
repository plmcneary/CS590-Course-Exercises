# CALCULATE COEFFICIENT OF VARIATION FOR EACH ROW PLOT
# INPUT DATA IS ALL IND AND HEADER FILES WITH A FEW OUTLIERS AND IMPROPERLY FORMATTED FILES REMOVED
library(lattice)
...
# Number of families = 113011; number of FS families = 91465; number of OP families = 21546
